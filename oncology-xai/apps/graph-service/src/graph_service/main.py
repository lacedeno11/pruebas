...
from graph_service.routes import graphs_router
...
app = FastAPI(
    title="Oncology XAI Graph Service",
    description="Graph assembly and management service for case visualization",
