"""Ontology Admin Service main application."""
...
from ontology_admin_service.routes import ontologies_router
...
app = FastAPI(
    title="Oncology XAI Ontology Admin Service",
    description="Ontology administration and versioning service",
